        ...
        <div class="container">
                    ...
                    <div class="container-fluid">
                        ...
                        <div class="collapse navbar-collapse" id="myNavbar">
                            <ul class="nav navbar-nav">
                                ...
                                <li class="active"><a href="<%= request.getContextPath()%>/order_details"><i class="fa fa-area-chart"></i> Détails de commande</a></li> 
                            </ul>
            ...
            <div class="col-md-8">
                <table class="table table-bordered table-striped table-responsive">
                    <thead>
                        <tr>
                            <th colspan="3" style="color: red;">Historique de commande</th>
                            <th colspan="4">
                                <input ng-model="searchText" type="text" class="form-control" placeholder="Rechercher et filtrer par nom de client"/>
                            </th>
                        </tr>
                        <tr>
                            <th style="width: 10px;">S.NO.</th>
                            <th style="width: 10px;">Id commande</th>
                            <th>Nom du client</th>
                            <th style="width: 20px;">Type de commande</th>
                            <th style="width: 100px;">Date de commande</th>
                            <th style="width: 100px;">Montant (TK)</th>
                            <th style="width: 20px;">Afficher les détails de la commande</th>
                        </tr>
                    </thead>
                    <tbody>
            ...
            <div class="col-md-4">
                <table class="table table-bordered table-responsive table-striped">
                    <thead>
                        <tr>
                            <th colspan="5">Détails de commande</th>
                        </tr>
                        <tr>
                            <th>ID</th>
                            <th>Nom produit</th>
